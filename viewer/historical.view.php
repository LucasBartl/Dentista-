        ...
        <form method="POST" >
            ...
            <div class="flex gap-2">
                ...
                <div class="w-100">
                    ...
                    <textarea 
                        name="obs_end"
                        class="rounded-2 p-2 writing bdcolor bg margiBottomAnotacoes w-100 h-10"></textarea>
                </div>
            ...
            <div class="flex justify-content-end mt-5">
                <button
                    type="submit"
                    class="rounded-2 p-2 bdcolor bg text-dark"
                    onclick="return confirm('Deseja realmente concluir este agendamento?')">
                    Salvar / Concluir
                </button>
            </div>
